...
st.markdown("<h4 style = 'margin: -30px; color: #F11A7B; text-align: center; font-family: cursive '>Built By Gomycode Data Science Salmon Crushers</h4>", unsafe_allow_html = True)
...
with robot_image: 
    robot_image.image('pngwing.com bot.png', width = 400)
